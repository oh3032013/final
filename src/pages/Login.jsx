...
function Login() {
  ...
  return (
    <div style={{ position: 'relative', minHeight: '100vh', minHeight: '100dvh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 'clamp(12px, 3vw, 16px)', overflow: 'hidden' }}>
      {/* الخلفية والأضواء */}
      ...
      <Link
        ...
        style={{ position: 'absolute', top: 'clamp(12px, 3vw, 24px)', left: 'clamp(12px, 3vw, 24px)', padding: '8px 16px', fontSize: '13px', borderRadius: '4px', gap: '6px' }}
      >
